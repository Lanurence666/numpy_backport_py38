...
// PyObject_VectorcallDict() - Python 3.9.0a1
...
// PyObject_VectorcallMethod() - Python 3.9.0a1
#if PY_VERSION_HEX < 0x030900A1
static inline PyObject*
...
#ifndef Py_tp_mro
#define Py_tp_mro offsetof(PyTypeObject, tp_mro)
#endif
#ifndef Py_tp_dict
#define Py_tp_dict offsetof(PyTypeObject, tp_dict)
#endif
#ifndef Py_tp_name
#define Py_tp_name offsetof(PyTypeObject, tp_name)
#endif
#ifndef Py_tp_flags
#define Py_tp_flags offsetof(PyTypeObject, tp_flags)
#endif
#ifndef Py_tp_as_number
#define Py_tp_as_number offsetof(PyTypeObject, tp_as_number)
#endif
#ifndef Py_tp_as_sequence
#define Py_tp_as_sequence offsetof(PyTypeObject, tp_as_sequence)
#endif
#ifndef Py_tp_as_mapping
#define Py_tp_as_mapping offsetof(PyTypeObject, tp_as_mapping)
#endif
...
// PyInterpreterState_GetDict() - Python 3.9.0a1
...
// PyErr_GetExcInfo() / PyErr_SetExcInfo() - Python 3.9.0a1
// These were made public in 3.9 but exist internally in 3.8.
#if PY_VERSION_HEX < 0x030900A1 && !defined(PYPY_VERSION)
...
// Py_GenericAlias() - Python 3.9.0a2
#if PY_VERSION_HEX < 0x030900A2
#ifndef _PYCAPI_COMPAT_Py_GenericAlias
#define _PYCAPI_COMPAT_Py_GenericAlias
static inline PyObject* Py_GenericAlias(PyObject *cls, PyObject *args)
{
    PyObject *mod = PyImport_ImportModule("typing");
    if (mod == NULL) return NULL;
    PyObject *ga_type = PyObject_GetAttrString(mod, "_GenericAlias");
    Py_DECREF(mod);
    if (ga_type == NULL) {
        PyErr_Clear();
        Py_RETURN_NONE;
    }
    PyObject *result = PyObject_CallFunctionObjArgs(ga_type, cls, args, NULL);
    Py_DECREF(ga_type);
    return result;
}
#endif /* _PYCAPI_COMPAT_Py_GenericAlias */

#endif

// PyObject_CallMethodNoArgs() - Python 3.9.0a3
#if PY_VERSION_HEX < 0x030900A3
#ifndef _PYCAPI_COMPAT_PyObject_CallMethodNoArgs
#define _PYCAPI_COMPAT_PyObject_CallMethodNoArgs
...
#endif /* _PYCAPI_COMPAT_PyObject_CallMethodNoArgs */

#endif

// PyObject_CallMethodOneArg() - Python 3.9.0a3
#if PY_VERSION_HEX < 0x030900A3
#ifndef _PYCAPI_COMPAT_PyObject_CallMethodOneArg
#define _PYCAPI_COMPAT_PyObject_CallMethodOneArg
...
#endif /* _PYCAPI_COMPAT_PyObject_CallMethodOneArg */
