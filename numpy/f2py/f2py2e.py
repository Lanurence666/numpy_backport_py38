...
def f2py_parser():
    ...
    parser.add_argument("--freethreading-compatible", dest="ftcompat", action="store_true", default=False)
    parser.add_argument("--no-freethreading-compatible", dest="ftcompat", action="store_false")
    return parser
