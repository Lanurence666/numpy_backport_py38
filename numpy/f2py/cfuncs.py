...
character_from_pyobj(character* v, PyObject *obj, const char *errmess) {
    ...
    }
    {
        ...
        snprintf(mess + len, F2PY_MESSAGE_BUFFER_SIZE - len,
                " -- expected str, bytes or sequence-of-str-or-bytes, got ");
    ...
    }
    {
        ...
        if (err == NULL) {
            ...
            strcpy(mess, "try_pyarr_from_character failed"
                         " -- expected bytes array-scalar or array, got ");
            f2py_describe(obj, mess + strlen(mess));
            PyErr_SetString(err, mess);
        }
    }
                  ...
                  const char *errmess)
{
    ...
    if (tmp_fun == NULL) {
        fprintf(stderr,
                \"Call-back argument must be function, instance, instance.__call__ or f2py-function \"
                \"but got %s.\\n\",
